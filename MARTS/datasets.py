...
def get_multivariate(name):
    ...
    if name == 'ECONOMICS_1':
        ...
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/CLIMATIC_1.csv', index_col=('Date'))
    elif name == 'CLIMATIC_2':
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/CLIMATIC_2.csv', index_col=('Date'))
    elif name == 'CLIMATIC_3':
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/CLIMATIC_3.csv', index_col=('Date'))
    elif name == 'MOTOR':
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/MOTOR.csv', index_col=('Date'))
    elif name == 'IOT_1':
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/IOT_1.csv', index_col=('Date'))
    elif name == 'IOT_2':
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/IOT_2.csv', index_col=('Date'))
    elif name == 'IOT_3':
        return pd.read_csv('https://raw.githubusercontent.com/PatriciaLucas/AutoML/main/Datasets/IOT_3.csv', index_col=('Date'))
    elif name == 'IOT_4':
